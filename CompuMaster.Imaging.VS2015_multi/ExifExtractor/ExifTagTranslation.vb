...
Namespace CompuMaster.Drawing.Imaging
    ...
    ''' <summary>
    ''' 	Hash which translates between the numerical EXIF tag number and
    ''' 	the textual description of it.
    ''' </summary>
    Public Class ExifTagTranslation
        Inherits Hashtable

        ''' <summary>
        ''' 	Creates a new instance of this class and fills the hash table with all
        ''' 	known EXIF tags.
        ''' </summary>
        Public Sub New()
